		...
		<div class="container">
			<div class="row gallery">
				<div class="col-12 text-center">
					<h3>Наши работы</h3>
					<p>На данной странице Вы можете просмотреть некоторые наши работы, определиться с темой и оставить заявку)</p>
				</div>
				<div class="col-12 col-sm-12 col-md-12 col-lg-6 mt-5">
					<img alt="" src="img/gallery/1.jpg">
					<img alt="" src="img/gallery/7.jpg">
					<img alt="" src="img/gallery/3.jpg">
					<img alt="" src="img/gallery/4.jpg">
					<img alt="" src="img/gallery/5.jpg">
					<img alt="" src="img/gallery/6.jpg">
				</div>
				<div class="col-12 col-sm-12 col-md-12 col-lg-6">
					<img alt="" src="img/gallery/2.jpg">
					<img alt="" src="img/gallery/8.jpg">
					<img alt="" src="img/gallery/9.jpg">
					<img alt="" src="img/gallery/10.jpg">
					<img alt="" src="img/gallery/11.jpg">
				</div>
			</div>
			<a href="https://www.instagram.com/prophotomaster/" target="_blank">
				<div class="d-flex align-items-center instagram justify-content-center">
					<img class="logoinst" src="img/logoblack.svg" alt="">
					<h4>Посмотреть эти и другие фотографии</h4>
				</div>
			</a>
		</div>
	</section>
